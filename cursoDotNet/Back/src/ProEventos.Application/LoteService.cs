...
namespace ProEventos.Application
{
    public class LoteService : ILoteService
    {
        ...
        public LoteService(IGeralPersist geralPersist,
                             ...
                             IMapper mapper) //para injetar no servico o automapper
        {
        ...
        public async Task AddLote(int eventoId, LoteDto models)
        {
            try
            {
        ...
        public async Task<bool> DeleteLote(int eventoId, int loteId)
        {
            try
            {
                ...
                if (lote == null) throw new Exception("O Lote nao foi encontrado");
